...
const translations = {
  fr: {
    ...
    'booking.step': 'Étape',
    'booking.steps.dates': 'Choisissez vos dates',
    'booking.steps.datesDesc': 'Sélectionnez vos dates d\'arrivée et de départ',
    'booking.steps.guests': 'Nombre de personnes',
    'booking.steps.guestsDesc': 'Indiquez le nombre de voyageurs',
    'booking.steps.contact': 'Coordonnées',
    'booking.steps.contactDesc': 'Partagez vos informations de contact',
    'booking.steps.confirm': 'Confirmation',
    'booking.steps.confirmDesc': 'Recevez votre confirmation par email',
    'booking.needHelp': 'Besoin d\'aide?',
    'booking.contactDirectly': 'Contactez-nous directement',
    'booking.teamAvailable': 'Notre équipe est à votre disposition pour toute question',
    'booking.multipleLines': 'Plusieurs lignes disponibles',
    'booking.quickResponse': 'Réponse rapide',
    'booking.instantConfirmation': 'Confirmation instantanée',
    'booking.confirmationText': 'Votre demande de réservation sera traitée dans les plus brefs délais. Vous recevrez un email de confirmation avec tous les détails de votre séjour, les modalités de paiement et les instructions d\'arrivée.',
    ...
    'prices.calculator.bookNow': 'Réserver Maintenant',
    'prices.calculator.selectOptions': 'Sélectionnez le type de logement et le nombre de personnes',
    'prices.calculator.exceedsCapacity': 'Le nombre de personnes dépasse la capacité maximale. Prix basé sur la capacité maximale.',
    ...
    'footer.bookNow': 'Réservez maintenant',
    'footer.planStay': 'Planifiez votre séjour idéal à Agadir',
    ...
    'auth.loginSuccess': '🎉 Félicitations !',
    'auth.loginSuccessDesc': 'Vous êtes maintenant connecté. Bienvenue !',
  ...
  en: {
    ...
    'booking.step': 'Step',
    'booking.steps.dates': 'Choose your dates',
    'booking.steps.datesDesc': 'Select your arrival and departure dates',
    'booking.steps.guests': 'Number of guests',
    'booking.steps.guestsDesc': 'Indicate the number of travelers',
    'booking.steps.contact': 'Contact details',
    'booking.steps.contactDesc': 'Share your contact information',
    'booking.steps.confirm': 'Confirmation',
    'booking.steps.confirmDesc': 'Receive your confirmation by email',
    'booking.needHelp': 'Need help?',
    'booking.contactDirectly': 'Contact us directly',
    'booking.teamAvailable': 'Our team is available for any questions',
    'booking.multipleLines': 'Multiple lines available',
    'booking.quickResponse': 'Quick response',
    'booking.instantConfirmation': 'Instant confirmation',
    'booking.confirmationText': 'Your booking request will be processed as soon as possible. You will receive a confirmation email with all the details of your stay, payment methods and arrival instructions.',
    ...
    'footer.planStay': 'Plan your ideal stay in Agadir',
    'footer.book': 'Book',
    ...
    'auth.loginSuccess': '🎉 Congratulations!',
