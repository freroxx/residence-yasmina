  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95 btn-shine touch-target",
  {
    variants: {
      variant: {
        ...
        hero: "bg-background/10 backdrop-blur-sm border-2 border-background/50 text-background hover:bg-background/20 shadow-2xl hover:shadow-3xl",
        premium: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground shadow-lg hover:shadow-xl hover:shadow-primary/30 hover:from-primary/90 hover:to-primary/70",
      },
      size: {
